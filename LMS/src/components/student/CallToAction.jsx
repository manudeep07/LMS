  ...
  return (
    <div>
       ...
       <div className='flex items-center justify-center gap-6 mt-5 px-5 py-6'>
        <button className='bg-blue-600 rounded px-5 py-3 font-medium hover:bg-blue-700 text-white w-36 cursor-pointer'>Get Started</button>
        <button className='font-medium flex items-center justify-center gap-2 cursor-pointer'>Learn more <img src={assets.arrow_icon} alt="" /></button>
       </div>
    </div>
  )
}
