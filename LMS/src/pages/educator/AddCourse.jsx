  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex flex-col gap-1'>
          <p>Discount %</p>
          <input onChange={e => setDiscount(e.target.value)} value={discount} type="number" placeholder='0' className='outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500' required />
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer max-w-44" onClick={() => handleChapter('add')}>+ Add Chapter</div>
          ...
          {showPopup && (
            <div className="fixed inset-0 bg-gray-900/50 flex items-center justify-center z-50">
              <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-sm">
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 text-sm font-bold mb-2">Lecture Title</label>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 text-sm font-bold mb-2">Lecture URL</label>
                  <input
                    type="text"
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div className="mb-4 flex items-center">
                  ...
                  />
                  <label className="text-gray-700 text-sm font-bold">Is Preview Free?</label>
                </div>
        ...
        <button type="submit" className='bg-black text-white w-max py-2.5 px-8 rounded my-4 uppercase'>ADD</button>
      </form>
    </div>
  )
}
