...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-800 text-white px-6 md:px-20 lg:px-40 py-6">
      {/* Grid Section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col items-start sm:items-center gap-5">
          ...
          <ul className="flex flex-col gap-1 text-gray-300">
            ...
            <li className="hover:text-white cursor-pointer"><a href="#femail" onClick={() => {
              document.querySelector('#femail').focus();
            }}>Privacy policy</a></li>
          </ul>
        </div>
        ...
        <div className="hidden lg:flex flex-col gap-5">
          ...
          <div className="flex gap-2">
            <input 
              type="email" id="femail"
              placeholder="Enter your email"
              className="px-3 py-2 rounded bg-gray-700 border-white text-gray w-60 outline-none"
            />
            <button className="bg-blue-600 rounded px-6 py-2 hover:bg-blue-700 cursor-pointer">
              Subscribe
            </button>
          </div>
        </div>
